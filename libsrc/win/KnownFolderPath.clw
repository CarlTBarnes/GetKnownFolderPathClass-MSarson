...
KnownFolderPath.GetFolder PROCEDURE(LONG Folder, *CSTRING FolderPath)
FolderId LIKE(KNOWNFOLDERID)
  CODE
  CLEAR(FolderPath)
  IF ~SELF.SetFolderId(Folder, FolderId)
